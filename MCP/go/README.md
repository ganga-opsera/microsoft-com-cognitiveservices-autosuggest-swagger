# AutoSuggest Client MCP Server

This MCP (Model Content Protocol) server provides access to AutoSuggest Client API functionality through HTTP, HTTPS, and STDIO transport modes.
